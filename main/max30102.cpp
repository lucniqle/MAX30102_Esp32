...
esp_err_t max30102_config(void)
{
    ...
    error = max30102_writeRegister(MAX30102_PARTICLECONFIG, ((MAX30102_ADCRANGE_4096 & ~MAX30102_ADCRANGE_MASK) | (MAX30102_SAMPLERATE_400 & ~MAX30102_SAMPLERATE_MASK) | MAX30102_PULSEWIDTH_411));
    if (error != ESP_OK)
    {
        return error;
    }
